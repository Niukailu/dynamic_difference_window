...
/**
 *                                                          原论文概率    原论文轮数
 * SIMECK48_DIFFERENCE_FROM_0x20000_0x470000_PRECISION_14   -45.65        21
 * SIMECK48_DIFFERENCE_FROM_0x2_0x5_PRECISION_14            -45.18        21
 * 
 * SIMECK48_LINEAR_FROM_0x800000_0x1_PRECISION_14           -47.68        22
 * SIMECK48_LINEAR_FROM_0x280000_0x100000_PRECISION_14      -45.66        20
 * 
 * SIMECK64_DIFFERENCE_FROM_0x0_0x1_PRECISION_14            -62.82        31
 * SIMECK64_DIFFERENCE_FROM_0x1_0x2_PRECISION_14            -62.56        31
 * SIMECK64_DIFFERENCE_FROM_0x0_0x11_PRECISION_14           -62.48        30
 * 
 * SIMECK64_LINEAR_FROM_0x1_0x0_PRECISION_14                -62.77        31
 * SIMECK64_LINEAR_FROM_0x80000001_0x5_PRECISION_14         -63.67        28  
 * 
 * SIMON48_LINEAR_FROM_0x400004_0x1_PRECISION_17
 * 
 ...
 * 
 * SIMON64_LINEAR_FROM_0x1_0x0_PRECISION_14
...
#define SIMON64_LINEAR_FROM_0x1_0x0_PRECISION_14
...
/*************************** SIMON48 ***************************/
#ifdef SIMON48_LINEAR_FROM_0x400004_0x1_PRECISION_17
    #define SIMON48
    #define LINEAR
    #define PRECISION 17
    #define LOAD_ROUND 0
    const std::string name = "SIMON48_LINEAR_FROM_0x400004_0x1_PRECISION_17";
    const uint64_t begin_left = 0x1;
    const uint64_t begin_right = 0x400004;
#endif
...
/*************************** SIMON64 ***************************/
...
#ifdef SIMON64_LINEAR_FROM_0x1_0x0_PRECISION_14
    #define SIMON64
    #define LINEAR
    #define PRECISION 14
    #define LOAD_ROUND 0
    const std::string name = "SIMON64_LINEAR_FROM_0x1_0x0_PRECISION_14";
    ...
    #define PRECISION 13
    #define LOAD_ROUND 0
    const std::string name = "SIMON64_LINEAR_FROM_0x40000004_0x1_PRECISION_13";
    const uint64_t begin_left = 0x1;
    const uint64_t begin_right = 0x40000004;
#endif
...
#ifdef SIMON64_LINEAR_FROM_0x40000004_0x1_PRECISION_15
    #define SIMON64
    #define LINEAR
    #define PRECISION 15
    #define LOAD_ROUND 0
    const std::string name = "SIMON64_LINEAR_FROM_0x40000004_0x1_PRECISION_15";
    const uint64_t begin_left = 0x1;
    const uint64_t begin_right = 0x40000004;
#endif

#ifdef SIMON64_LINEAR_FROM_0x40000004_0x1_PRECISION_16
    #define SIMON64
    #define LINEAR
    #define PRECISION 16
    #define LOAD_ROUND 0
