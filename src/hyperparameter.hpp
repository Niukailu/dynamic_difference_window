 ...
 * SIMON96_DIFFERENCE_FROM_0x1_0x0_PRECISION_14
...
**/
// 在这里定义启用哪一个实验
#define SIMON128_LINEAR_FROM_0x4000000000000004_0x1_PRECISION_14
...
#ifdef SIMON96_DIFFERENCE_FROM_0x1_0x0_PRECISION_14
    #define SIMON96
    #define DIFFERENCE
    #define PRECISION 14
    #define LOAD_ROUND 0
    const std::string name = "SIMON96_DIFFERENCE_FROM_0x1_0x0_PRECISION_14";
