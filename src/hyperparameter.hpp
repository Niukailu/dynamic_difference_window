 ...
 * SIMON128_FROM_0x1000_0x4440_PRECISION_14
 * SIMON128_FROM_0x0_0x1_PRECISION_14
**/
// 在这里定义启用哪一个实验
#define SIMON128_FROM_0x0_0x1_PRECISION_14
...
#ifdef SIMON64_FROM_0x1_0x40000004_PRECISION_14
    #define SIMON64
    #define PRECISION 14
    #define LOAD_ROUND 0
    const std::string name = "SIMON64_FROM_0x1_0x40000004_PRECISION_14";
...
#ifdef SIMON96_FROM_0x4000_0x11101_PRECISION_14
    #define SIMON96
    #define PRECISION 14
    #define LOAD_ROUND 0
...
/*************************** SIMON128 ***************************/
#ifdef SIMON128_FROM_0x1000_0x4440_PRECISION_14
    #define SIMON128
    #define PRECISION 14
    #define LOAD_ROUND 0
    const std::string name = "SIMON128_FROM_0x1000_0x4440_PRECISION_14";
    const uint64_t begin_left = 0x1000;
    const uint64_t begin_right = 0x4440;
#endif

#ifdef SIMON128_FROM_0x0_0x1_PRECISION_14
    #define SIMON128
    #define PRECISION 14
    #define LOAD_ROUND 0
    const std::string name = "SIMON128_FROM_0x0_0x1_PRECISION_14";
