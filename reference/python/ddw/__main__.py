...
def main():
    ...
    if schedule_path:
        ...
        if (len(schedule) < args.rounds and not args.continue_search) or any(
    ...
    with args.output.open("x") as output:
        ...
        for round_no in range(1, args.rounds + 1):
            ...
            ref = schedule[round_no - 1] if round_no <= len(schedule) else None
            include = (
            ...
            candidates = (
                [include]
                if args.replay_windows and include is not None
